...
const addValues = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((integer, value, index) =>{
...
const addPurchases = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((purchases, value, index) => {
    purchases = purchases + value.purchasePrice;
    return purchases;
  },0);
  return newArr;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((numbers, value, index) => {
    numbers = index + 1;
    return numbers;
  },0);
  return newArr;
...
const returnNames = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((names, value, index) =>{
