...
let biggerThanLuke = (arr) => {
  ...
  let testMass = parseInt(arr.find(value => value.name === 'Luke Skywalker').mass);
  return arr.filter(value => value.mass > testMass).map(val => val.name).join(' - ');
};
